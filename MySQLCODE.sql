...
--- CONCAT()
DECLARE @LNAME VARCHAR(5) ='AJ'
DECLARE @FNAME VARCHAR(10) = 'AMINATOU'
...
SELECT DISTINCT LEFT(CITY,3) AS CITYABBRV
FROM HR.Employees
...
SELECT DISTINCT RIGHT(CITY,3) AS CITYABBRV,CITY
FROM HR.Employees

---SUBSTRING()
DECLARE @FNAME VARCHAR(10) = 'AMINATOU'
SELECT SUBSTRING(@FNAME, 4, 3)

---RETRIEVE THE NEXT 3 CHARACTERS FROM  THE 2 POSITION IN EMPLOYEES CITY
SELECT DISTINCT SUBSTRING(CITY,2,3) AS CITYABBRV,CITY
FROM HR.Employees
